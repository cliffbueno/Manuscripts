...
# PC1 general trend is the same. PC2 is very different! But not going to use PC2 anyway. The reasoning is that sometimes things driving PC2 like moisture may actually be relagated to PC3 in some windows! PC1 is always related to Temp and GDD.
...
# Try Segmented (I think this is best)
library(segmented)
m <- lm(T.GSL.R ~ windowstart, data = cor.df)
summary(m)
my.seg1 <- segmented(m,
